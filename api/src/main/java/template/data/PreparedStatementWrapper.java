...
import template.util.LoggingFilter;
...
public class PreparedStatementWrapper implements PreparedStatement {
    ...
    public PreparedStatementWrapper(String sql, PreparedStatement preparedStatement) {
    ...
    public ResultSet executeQuery() throws SQLException {
        ...
        try {
            if (MDC.get(LoggingFilter.SESSION_ID) != null)
                log(LOG_SEP + "sql=" + dumpedSql);
            ResultSet r = preparedStatement.executeQuery();
            if (MDC.get(LoggingFilter.SESSION_ID) != null)
                log(LOG_SEP + "sql=" + dumpedSql + LOG_SEP + "result=finished");
            return r;
        } catch (SQLException s) {
            log("status=failed" + LOG_SEP + "error=" + s.toString() + LOG_SEP + "sql=" + dumpedSql);
            throw s;
        }
    }
    ...
    public int executeUpdate() throws SQLException {
        ...
        try {
            ...
            log(LOG_SEP + "sql=" + dumpedSql + LOG_SEP + "result=" + result);
            return result;
        } catch (SQLException s) {
            log(LOG_SEP + "status=failed" + LOG_SEP + "error=" + s.toString() + LOG_SEP + "sql=" + dumpedSql);
            throw s;
        }
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        ...
        log(LOG_SEP + "sql=" + sql + LOG_SEP + "result=finished");
        return r;
    }
    ...
    public void cancel() throws SQLException {
        String dumpedSql = dumpedSql();
        log(LOG_SEP + "sql=" + dumpedSql + LOG_SEP + "cancel");
    ...
    public boolean execute(String sql) throws SQLException {
        log(LOG_SEP + "sql=" + sql);
        boolean r = preparedStatement.execute(sql);
        log(LOG_SEP + "sql=" + sql + LOG_SEP + "result=finished");
        return r;
    }
    ...
    public int[] executeBatch() throws SQLException {
        log(LOG_SEP + "sql=Batch_sql:" + currentBatch.toString());
        int[] r = preparedStatement.executeBatch();
        log(LOG_SEP + "sql=Batch_sql" + currentBatch.toString() + LOG_SEP + "result=finished");
        currentBatch.clear();
        return r;
    }
    ...
    public int executeUpdate(String sql, int autoGeneratedKeys) throws SQLException {
        log(LOG_SEP + "sql=" + sql);
        int r = preparedStatement.executeUpdate(sql, autoGeneratedKeys);
        log(LOG_SEP + "sql=" + sql + LOG_SEP + "result=finished");
        return r;
    }
    ...
    public int executeUpdate(String sql, int[] columnIndexes) throws SQLException {
        log(LOG_SEP + "sql=" + sql);
        int r = preparedStatement.executeUpdate(sql, columnIndexes);
        log(LOG_SEP + "sql=" + sql + LOG_SEP + "result=finished");
        return r;
    }
    ...
    public int executeUpdate(String sql, String[] columnNames) throws SQLException {
        log(LOG_SEP + "sql=" + sql);
        int r = preparedStatement.executeUpdate(sql, columnNames);
        log(LOG_SEP + "sql=" + sql + LOG_SEP + "result=finished");
        return r;
    }
    ...
    public boolean execute(String sql, int autoGeneratedKeys) throws SQLException {
        log(LOG_SEP + "sql=" + sql);
        boolean r = preparedStatement.execute(sql, autoGeneratedKeys);
        log(LOG_SEP + "sql=" + sql + LOG_SEP + "result=finished");
        return r;
    }
    ...
    public boolean execute(String sql, int[] columnIndexes) throws SQLException {
        log(LOG_SEP + "sql=" + sql);
        boolean r = preparedStatement.execute(sql, columnIndexes);
        log(LOG_SEP + "sql=" + sql + LOG_SEP + "result=finished");
        return r;
    }
    ...
    public boolean execute(String sql, String[] columnNames) throws SQLException {
        log(LOG_SEP + "sql=" + sql);
        boolean r = preparedStatement.execute(sql, columnNames);
        log(LOG_SEP + "sql=" + sql + LOG_SEP + "result=finished");
        return r;
    }
	...
	private void log(String message) {
		try {
            ...
            Logger.warn("Failed to log message, probably because it's too large.", ex);
        }
	}
}
